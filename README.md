...
El [estudio de reentrada, régimen y protección de beneficios](docs/guides/regime-study.md) preregistra una segunda cuadrícula de 48 configuraciones SMA50/200 con/sin trailing y una meta económica de 0,05 % diario observada y normalizada; por ahora solo admite TRAIN y no activa ningún perfil.
