...
Las operaciones reproducibles, el backup seguro y la activación del health timer están en la [guía del laboratorio local](docs/guides/local-lab.md). El código se publica en el repositorio propio [btc-lab](https://github.com/jorgehn98/btc-lab), no en un fork.
