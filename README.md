...
El [estudio de reentrada, régimen y protección de beneficios](docs/guides/regime-study.md) probó una segunda cuadrícula de 48 configuraciones SMA50/200 con/sin trailing y meta exploratoria de 0,05 % diario observado y normalizado. Terminó TRAIN sin preseleccionados; VALIDATION y TEST siguen cerrados y no se activó ningún perfil.
